...
export const COPY = {
  ...
  SETTINGS_SYNC_MODE:     "What to sync",
  SYNC_MODE_LINKS:        "Links only",
  SYNC_MODE_LINKS_DESC:   "Private — your preferences stay on this device.",
  SYNC_MODE_EVERYTHING:   "Links + preferences",
  SYNC_MODE_EVERYTHING_DESC: "Theme and sort order follow you across devices.",
